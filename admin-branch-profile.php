							...
							<form method="post" action="admin-branch-add.php">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-6">
												<textarea type="text" class="form-control" name="address" id="address" value="<?php echo $branches['location']; ?>" placeholder=" Address " rows="4" maxlength="512" required></textarea>
											</div>
										</div>
									</div>
								</div>
