										...
										<div class="row">
											<div class="col-md-3">
												<div class="card mb-4 p-2" style="background-color:#e2e8e5">
													<img height="250" width="200" class="card-img-top p-4" src="assets/images/User_creation.png" alt="Image">
													<div class="card-body">
											...
											<div class="col-md-3">
												<div class="card mb-4 p-2" style="background-color:#e2e8e5">
													<img height="250" width="200" class="card-img-top p-4" src="assets/images/department_creation.png" alt="Image">
													<div class="card-body">
