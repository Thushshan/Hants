...
<?php
			...
			if(isset($_POST["update"]))
			{
				...
				if($result_check->num_rows>0){
								  ...
								  header("Location: payments-search-course-enroll.php");
				}
				else{
				...
				where id = '$id'";
						  ...
						  if($conn->query($sql_ins) == true){
							  		set_success_msg("<strong>Success!</strong> Course fee has been successfully updated!");
									header("Location: payments-search-course-enroll.php");
							  }
						  else{
			...
			if(isset($_POST["delete"]))
			{
				...
				$sql_ins = "delete from incomes where id = '$id'";
						  ...
						  if($conn->query($sql_ins) == true){
							  		set_success_msg("<strong>Success!</strong> Course fee has been successfully deleted!");
									header("Location: payments-search-course-enroll.php");
							  }
						  else{
								  set_error_msg("<strong>Oops!</strong> Something went wrong!...!");
				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="payments-search-course-enroll.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											<input type="text" class="form-control" name = "search"  placeholder="Subject,Payment Method,Status">
									...
									<div class="col-md-12">
										<table class="table table-bordered">
											<thead>
														...
														if(isset($_POST['search']))
															{
																...
																$sql  = "select * from incomes WHERE catogory = 'Course Management' and
																												(status LIKE '%$searchq%' or
																												description LIKE '%$searchq%' or
																												payment_method LIKE '%$searchq%') 
																												";	}
															else {
																		$sql = "SELECT * FROM incomes where catogory = 'Course Management'";
															}
												...
												<tbody>
												<form action="payments-search-course-enroll.php" method= "post">
												<tr>
																<th scope="row"><center><?php echo $row['course_enrollment_id']; ?></center></th>
																<td>
                                                                ...
                                                                <td>
                                                                <input type="text" placeholder=" Payment Method " value="<?php echo $row['payment_method']; ?>" class="form-control" required name="pay_method">
                                                                </td>
