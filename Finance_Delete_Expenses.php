...
if(isset($_POST["delete"])){
	...
	$sql_del = "delete from expenses where id='$id'";
						if($conn->query($sql_del) == true){
							  		set_success_msg("<strong>Success!</strong> EXP".$id." successfully deleted!");
									header("Location: Finance_Delete_Expenses.php");
							  }
						  else{
				...
				<div class="col-md-10">
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active"><strong> Delete Expenses 
                            <?php if($row_tot>0){
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Delete_Expenses.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Delete_Expenses.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
											...
											?>
                                            			<tbody>
															<tr class="<?php echo $bg_color; ?>">
                                                                ...
                                                                <form action="Finance_Delete_Expenses.php" method="post" onSubmit="return confirm('WARNING!\n\n1. Accidentally deletion of records cannot backup from the system.\n2. There is no way to undo this action.\n\nDo you still really want to delete EXP<?php echo $row["id"]; ?>?');">
