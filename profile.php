...
<?php
	...
	if (isset($_POST['mobile_no']) && isset($_POST['address']) && isset($_POST['email'])) {
		...
		if($sm->update_employee_profile($userid, $mobile_no, $address, $email, $password)){
			set_success_msg("<strong> Success!</strong> Profile Successfully updated!... ");
		}
							...
							<form action="profile.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-6">
                                                <select size="4" class="form-control" multiple disabled>
													<?php
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $user['firstname']; ?>" disabled>
												<small class="form-text text-muted">First Name</small>
											</div>
											<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $user['lastname']; ?>" disabled>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-6">
												<input type="text" class="form-control" value="<?php echo $user['nicno']; ?>" disabled>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-6">
												<input type="text" class="form-control" name="mobile_no" value="<?php echo $user['mobileno']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="form-row">
											<div class="col-md-6">
												<textarea type="text" class="form-control" name="address" rows="3"><?php echo $user['location']; ?></textarea>
