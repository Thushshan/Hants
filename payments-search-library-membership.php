...
include_once "DB_Connection.php" ;
			...
			if(isset($_POST["update"]))
			{
				...
				if($result_check->num_rows>0){
								  ...
								  header("Location: payments-search-library-membership.php");
				}
				else{
				...
				where id = '$id'";
						  ...
						  if($conn->query($sql_ins) == true){
							  		set_success_msg("<strong>Success!</strong> Library Membership fee has been successfully updated!");
									header("Location: payments-search-library-membership.php");
							  }
						  else{
			...
			if(isset($_POST["delete"]))
			{
				...
				$sql_ins = "delete from incomes where id = '$id'";
						  ...
						  if($conn->query($sql_ins) == true){
							  		set_success_msg("<strong>Success!</strong> Library Membership fee has been successfully deleted!");
									header("Location: payments-search-library-membership.php");
							  }
						  else{
								  set_error_msg("<strong>Oops!</strong> Something went wrong!...!");
				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="payments-search-library-membership.php">
								<div class="row">
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<table class="table table-bordered">
											<thead>
														...
														if(isset($_POST['search']))
															{
																...
																$sql  = "select * from incomes WHERE catogory='Library Management' and description='Membership Fees' and
																												(payment_method LIKE '%$searchq%' OR
																												status LIKE '%$searchq%')";	}
															else {
																		$sql = "SELECT * FROM incomes where catogory='Library Management' and description='Membership Fees'";
															}
												...
												<tbody>
												<form action="payments-search-library-membership.php" method= "post">
												<tr>
																<th scope="row">
																...
																?>
																<td>
                                                                <input type="number" value="<?php echo $row['amount']; ?>" name="amount" min="0" required="required" placeholder=" Membership Fee " class="form-control" />
                                                                </td>
                                                                <td>
