				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Update_Incomes.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Update_Incomes.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
                                            ...
                                            <?php
												if(isset($_POST["search"])){
													...
													if(empty($s_text)){
														...
														$sql_delete = "select * from incomes where ".$search." like '%".$s_text."%' and catogory not in ('Student','Library Management','Exam Management','Course Management')";
													}
													
												}else{
													$sql_delete = "select * from incomes where catogory not in ('Student','Library Management','Exam Management','Course Management')";
												}
                                            			...
                                            			<tbody>
                                                            ...
                                                            <?php $inc_id = $row["id"]; ?>
                                                    			...
                                                    			<th scope="row" class="<?php echo $row["status"]; ?>"><?php echo $row["status"]; ?></th>
                                                   				<th scope="row">
                                             					<form action="Finance_Update_Incomes_View.php" method="post" onSubmit="return confirm('WARNING!\n\n1. Accidentally updation of records cannot backup from the system.\n2. There is no way to undo this action.\n\nDo you still really want to update INC<?php echo $row["id"]; ?>?');">
